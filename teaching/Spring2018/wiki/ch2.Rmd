---
title: "Chapter 2: Time Series Regression and Exploratory Data Analysis"
...
* Linear regression: assumption, matrix form, OLS estimator $(\hat\beta, s^2)$, MLE estimator $\hat\sigma^2$, properties of $\hat\beta$
* Testing and model selection: t-test, F-test, forward and backward selection, AIC and BIC

## 2. Exploratory Data Analysis
* Detrend: regression and differencing, backshift operator, transformation, scatterplot matrices, periodic behavior
* Smoothing: moving average smoother, regression smoother, kernel smoothing, Lowess, spline smoothing
